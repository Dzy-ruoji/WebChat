...
function getCheckCode() {
    if(checkEmail()){
        ...
        jsonObj_1.email=document.getElementById("email").value;
        var json= JSON.stringify(jsonObj_1);
        var xhttp;
        ...
        xhttp.open("POST", "/user/checkMailCode", true);
        ...
        document.getElementById("Error_Msg").innerText="请输入正确邮箱，验证码将会发送至您的邮箱";
    }
