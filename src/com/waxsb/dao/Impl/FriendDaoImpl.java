...
public class FriendDaoImpl implements FriendDao {
    ...
    @Override
    public List<Friend> findFriendByMyName(Connection conn, String username) {
    ...
    @Override
    public void insert(Connection conn, AddFriend addFriend) {
    ...
    @Override
    public List<AddFriend> findFriendRequest(Connection conn, String username) {
    ...
    @Override
    public List<AddFriend> findFriendRespond(Connection conn, String username) {
    ...
    @Override
    public void friendReqResp(Connection conn, AddFriend addFriend) {
    ...
    @Override
    public void updateNickname(Connection conn,String myName, String friendName, String nickname) {
