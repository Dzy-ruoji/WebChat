...
public class GroupsDaoImpl implements GroupsDao {
    ...
    @Override
    public void createGroup(Connection conn, User_Groups user_groups) throws SQLException {
    ...
    @Override
    public void updateGroupName(Connection conn, int ug_id, String ug_name) throws SQLException {
        String sql = "update user_groups set UG_Name=? where UG_ID=?";
        baseDao.update(conn,sql,ug_name,ug_id);
    }

    @Override
    public void updateGroupAdmin(Connection conn, int ug_id, int ug_adminID) throws SQLException {
        String sql = "update user_groups set UG_AdminID=? where UG_ID=?";
        baseDao.update(conn,sql,ug_adminID,ug_id);
    }

    @Override
    public User_Groups  getGroupByNum(Connection conn, String ug_number) throws SQLException, NoSuchFieldException, InstantiationException, IllegalAccessException {
    ...
    @Override
    public List<User_GroupsToUser> getMyGroups(Connection conn, int id) throws SQLException, InstantiationException, IllegalAccessException, NoSuchFieldException {
    ...
    @Override
    public List<User_GroupsToUser> getUserMsg(Connection conn, int ug_id) throws SQLException, InstantiationException, IllegalAccessException, NoSuchFieldException {
    ...
    @Override
    public User_Groups getGroupById(Connection conn, int ug_id) throws SQLException, NoSuchFieldException, InstantiationException, IllegalAccessException {
    ...
    @Override
    public void insert(Connection conn, AddGroups addGroups) throws SQLException {
        String sql = "insert into t_addgroup(Uid,UG_ID) value(?,?)";
        baseDao.update(conn,sql,addGroups.getUid(),addGroups.getUG_ID());
    }

    @Override
    public void updateAnnouncement(Connection conn, int ug_id, String announcement) throws SQLException {
        String sql = "update user_groups set announcement=? where UG_ID=?";
        baseDao.update(conn,announcement,ug_id);
    }

    @Override
    public List<AddGroups> findGroupsRespond(Connection conn, int id) throws SQLException, InstantiationException, IllegalAccessException, NoSuchFieldException {
    ...
    @Override
    public List<User_GroupsToUser> getManager(Connection conn, int id) throws SQLException, InstantiationException, IllegalAccessException, NoSuchFieldException {
    ...
    @Override
    public List<AddGroups> findGroupsRequest(Connection conn, int ug_groupID) throws SQLException, InstantiationException, IllegalAccessException, NoSuchFieldException {
    ...
    @Override
    public void updateAddGroup(Connection conn, int uid, int ug_id, String isAllow) throws SQLException {
        String sql ="update t_addgroup set isAllow = ? where Uid=? and UG_ID=?";
        baseDao.update(conn,sql,isAllow,uid,ug_id);
    }

    @Override
    public void insertGroupsToUser(Connection conn, User_GroupsToUser groupsToUser) throws SQLException {
    ...
    @Override
    public void deleteMsg(Connection conn, int uid) throws SQLException {
    ...
    @Override
    public List<User> getGroupManagers(Connection conn, int ug_groupID) throws SQLException, InstantiationException, IllegalAccessException, NoSuchFieldException {
    ...
    @Override
    public List<User> getMemberName(Connection conn, int ug_groupId) throws SQLException, InstantiationException, IllegalAccessException, NoSuchFieldException {
